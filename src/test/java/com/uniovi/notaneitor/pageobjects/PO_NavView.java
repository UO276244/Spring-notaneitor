...
public class PO_NavView extends PO_View {
     ...
     * comprueba que se vaya a la vista con el elemento de tipo type con el texto Destino
     *
    ...
    public static void clickOption(WebDriver driver, String textOption, String criterio, String targetText) {
        ...
        //Tiene que haber un sólo elemento. Assertions.assertEquals(1, elements.size());
        // Ahora lo clickamos
